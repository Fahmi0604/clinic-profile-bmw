...
export async function generateStaticParams() {
    // const blogs = await findAllPublishedBlogSlugs();
...
export default async function BlogPage({ params }: { params: Promise<{ slug: string }> }) {
    ...
    const blog = blogs.map((m) => ({
        ...
        layout: 'COL'
        // imageBefore: '/assets/dokter/beforetest.jpg',
        // imageAfter: '/assets/dokter/aftertest.jpg',
        // layout: 'ROW'
    })).find((e) => e.slug === slug);
        ...
        <>
            ...
            <section className="flex justify-center px-4 py-8 md:py-20">
                <div className='w-full md:max-w-3xl xl:max-w-4xl'>
                    ...
                    <h1 className='mb-1 text-3xl text-heading-1 font-semibold'>{blog.title}</h1>
