    ...
    return (
        <section className='flex justify-center px-4 py-8 md:py-20 bg-gradient-to-t from-gray-primary to-white'>
            <div className='md:max-w-5xl xl:max-w-6xl'>
                <h3 className="text-3xl font-gotham font-bold text-heading-1 mb-6 md:mb-10">Tim Dokter Profesional dan Tepercaya</h3>

                <div className='w-full flex flex-col md:flex-row justify-around items-center gap-5 md:gap-0'>
                    {dokter.map((e) => (
                        <div key={e.id} className='relative w-full md:w-[31%] h-[400px] md:h-[50vh] xl:h-[60vh] rounded-xl overflow-hidden flex items-center justify-center shadow'>
                            <Image
                                src={e.image}
                                alt={e.name}
                                width={200}
                            ...
                            <div className='w-full absolute bottom-0'>
                                ...
                                <div className='w-full p-6 bg-blue-primary text-white '>
                                    <h4 className='text-lg md:text-[22px] font-semibold font-gotham'>{e.name}</h4>
                                    <p className='text-lg'>{e.spesalis}</p>
                                </div>
                            </div>
                        </div>
                    ))}
